...
import falcon
from falcon.data.weighted_combined_loader import WeightedCombinedLoader
import falcon.data.samplers as gr_samplers
from falcon.utils.dist_train import get_rank, is_dist
from falcon.utils.common import collate_with_none
...
class GRDataModule(pl.LightningDataModule):
    ...
    def _init_dataset(self, dataset_config, batch_size, num_workers, is_training=True):
        ...
        dataset = getattr(falcon.data, dataset_type)(**dataset_config)
    ...
    def _init_iterable_dataset(
        ...
        dataset = getattr(falcon.data, datset_type)(**dataset_config)
