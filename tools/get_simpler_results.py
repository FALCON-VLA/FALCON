...
if __name__ == "__main__":
    ...
    # for gr eval results
    # task = "pick_coke_can"
    log_dir_root = "oxe_vid_results/results_v3"
    ckpt_name = 'finetune_kosmos_cont-lstm-post_full-ft_text_vision_wd=0_hist=16_act=10_use-hand_aug-shift_act-norm_lr-2e-5_oxe_01-16_kosmos_ph_oxe-pretrain.pt'
    ...
    # for bridge eval results
    # log_dir_root = "results_v3"
    # ckpt_name = 'finetune_kosmos_cont-lstm-post_esm_part-ft_vlm-spatial-injector_wd-0_ws-16_act-10_bridge_finetune_15-27_epoch=0-step=30000.ckpt'
